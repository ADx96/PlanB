...
import imgAPI from "common/assets//images/imgAPI";
          ...
          <Grid item md={7} xs={12}>
            <div className={classes.text}>
              <Typography variant="h3">
                {"common:mobile-landing.banner_title"}
                &nbsp;
                <strong>{"common:mobile-landing.banner_titlestrong"}</strong>
              </Typography>
              <Typography variant="h5">
                {"common:mobile-landing.banner_desc"}
              </Typography>
            ...
            <div className={classes.decoration}>
              <div className={classes.phoneIllustration}>
                ...
                <Hidden mdDown>
                  <img
                    src={imgAPI.mobile[1]}
                    className={clsx(classes.widgetTop, "fragment-fadeUp")}
                    alt="illustration"
                  />
                  <img
                    src={imgAPI.mobile[2]}
                    className={clsx(classes.widgetLeft, "fragment-fadeUp")}
                    alt="illustration"
                  />
                  <img
                    src={imgAPI.mobile[3]}
                    className={clsx(classes.widgetRight, "fragment-fadeUp")}
                    alt="illustration"
                  />
                </Hidden>
              </div>
